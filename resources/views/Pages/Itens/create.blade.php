        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h1 class="fs-2 text-center font-bold mb-4">Criar Item</h1>
                    <form action="{{ route('admin.item.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <x-text-input id="nome_item" class="block mt-1 w-full" type="text" name="nome_item" :value="old('nome_item')" required />
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <x-text-input id="descricao_item" class="block mt-1 w-full" type="text" name="descricao_item" :value="old('descricao_item')" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select id="item_id_user" name="item_id_user" class="form-select @error('item_id_user') is-invalid @enderror">
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ old('item_id_user') == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select id="item_id_status" name="item_id_status" class="form-select">
                                    @foreach ($status_itens as $status)
                                        <option value="{{ $status->id_status_item }}" {{ old('item_id_status') == $status->id_status_item ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select id="item_id_tipo" name="item_id_tipo" class="form-select">
                                    @foreach ($tipo_itens as $tipo)
                                        <option value="{{ $tipo->id_tipo_item }}" {{ old('item_id_tipo') == $tipo->id_tipo_item ? 'selected' : '' }}>
                                            {{ $tipo->nome_tipo_item }}
                                        </option>
                                    @endforeach
                                </select>
