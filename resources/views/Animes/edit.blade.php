...
<head>
    <livewire:head />
    <title>Acevo - Editar um item</title>
</head>
<body>
    <livewire:header />
    ...
    <main class="container-fluid py-3">
      <div class="bg-dark p-5 rounded-4">
        <H3 class="text-center text-white p-2">Editar conteúdo</H3>
        <form id="Adicionar_conteudo" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="text-center pt-3">
                <button type="button" class="btn btn-primary" onclick="Adicionar_conteudo()">Salvar</button>
            </div>
        </form> 
      </div>
    </main>
